...
async function createDataModelInSigma(dataModelSpec) {
    ...
    try {
        ...
        //console.log('data model created successfully:', JSON.stringify(response.data, null, 2));
        return response.data.dataModelId;   

    } catch (error) {
        console.error('error creating data model in Sigma:', error.response ? error.response.data : error.message);
        throw error;
    }
